...
%---------------------------------------------------------------------------------------------------
  ...
  \createAbstract					{Bachelor}																			% type of thesis
													...
													Simulation Verteiltes System}											  % Titel German				
													{Design and Implementation of an Archive Microservice solution for the Multi-Agent Research and
													Simulation Distributed System}							% Titel English
													{Verteilte Systeme, Microservice, Zwei-Phasen-Commit-Protokolle, Archiv, Dezentrale Daten, Multi-Agent Research and Simulation (MARS)}																		% Stichworte
													{Distributed System, Microservice, Two-Phase commit protocol, Archive, Decentralized data, Multi-Agent Research and Simulation (MARS)}																			% Keywords 
