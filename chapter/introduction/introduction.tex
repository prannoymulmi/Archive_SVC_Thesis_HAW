...
%\part{start}
    ...
    \section{Problem Statement}
        ...
        to the existing MARS\footnote{MARS: Multi Agent Research and Simulation} system.
        ...
        \begin{enumerate}
            ...
            proper understanding of this hierarchy restoring, archiving data will lead to corrupted states. Therefore, understanding this complex structure plays 
            ...
            \item
            \textbf{Operational complexities}, Due to the diverse services that have to be managed, the system in addition has operational complexities. Thus, it is a challenge 
