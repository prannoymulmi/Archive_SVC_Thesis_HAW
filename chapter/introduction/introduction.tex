...
%\part{start}
    ...
    \section{Problem statement}
        ...
        \begin{enumerate}
            ...
            \item 
            \textbf{Data inconsistency and incoherence:} The design for communication in the MARS system is only via remote network call like HTTP\footnote{HTTP: Hyper Text Transfer Protocol} 
            ...
            process can unintentionally be led in to a false state in case of failure during communication. The presence  
