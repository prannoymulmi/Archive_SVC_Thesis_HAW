...
%\part{start}
    \chapter{Introduction}
        \section{Motivation}
            ...
            A high level of correlation has been observed between the operating cost of a software system and its data volume. 
    ...
    \section{Problem Statement}
        ...
        \begin{enumerate}
            ...
            \item 
            \textbf{Understanding MARS resource hierarchy}, The MARS Resource Hierarchy is the order how the assets in the system has to be created. Without the
