...
\par
    ...
    built as a large unit where all the application logic lies within a single system. 
    ...
    application to be scaled as a whole. This is where microservices can be beneficial,
