\section{Distributed Systems}
    ...
    this architecture, so that one can anticipate how the MARS framework operates in the background and
    ...
    distributed amongst different computers. It can also be seen that the the different parts of the application are allowed
    ...
    resources (e.g CPU power, memory and storage) located on another machine.
    ...
    \subsection{Challenges}    
        ...
        Since a distributed system is susceptible to network failures, therefore a network partition \cite[p.~59]{CAP} cannot be avoided. In presence
        ...
        Errors are imminent in every application and for it to continue working normally again it has to be able to detect and recover from them.
