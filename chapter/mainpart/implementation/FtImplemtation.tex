...
To solve this issue the interceptor pattern is used in here. Using this pattern a decorator would be added in the class which wants to include the common
