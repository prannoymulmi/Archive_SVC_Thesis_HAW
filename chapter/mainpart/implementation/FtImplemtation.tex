...
occurs. It is backed up with a persistent storage where the job parameters are stored. It is very easy to configure and to maintain. Listing \ref{lst:hangfire}
